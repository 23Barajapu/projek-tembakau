                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4" style="color:  #81c408">Forgot
                                            Password</h5>
                                        <p class="text-center small">Silakan masukkan email untuk melakukan
                                            reset password</p>
                                    </div>
                                    @if ($errors->any())
                                    ...
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="text-center">
                                            <button class="btn btn-primary border-2 text-white w-100"
                                                ...
                                                type="submit">Password Reset Link</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
