                        ...
                        <div class="card info-card sales-card">
                            <div class="container"><br>
                                <button class="btn btn-primary bg-light me-2 text-primary rounded-pill">
                                    <a href="{{ route('kategori.create') }}" type="button" class="icon-link"><i
                                            class="bx bxs-book-add py-2"></i>Tambah</a>
                                </button><br>
                                ...
                                @if ($kategori->isEmpty())
                                    <div class="alert alert-warning mt-3">
                                        <strong>Peringatan!</strong> Tidak ada kategori di data kategori.
                                    </div>
                                @else
