                    ...
                    <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active rounded">
                                <img src="  Template FrontEnd/img/hero-img-1.png"
                                    class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                <a href="#" class="btn px-4 py-2 text-white rounded">Fruites</a>
                            </div>
                            <div class="carousel-item rounded">
                                <img src="  Template FrontEnd/img/hero-img-2.jpg" class="img-fluid w-100 h-100 rounded"
                                    alt="Second slide">
                            ...
                            <div class="carousel-item rounded">
                                <img src="  Template FrontEnd/img/hero-img-2.jpg" class="img-fluid w-100 h-100 rounded"
                                    alt="Third slide">
                                <a href="#" class="btn px-4 py-2 text-white rounded">Vesitableees</a>
                            </div>
                        </div>
                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 d-flex align-items-stretch">
                                <div class="rounded position-relative fruite-item flex-fill d-flex flex-column">
                        ...
                        <div class="col-12">
                            <div class="pagination d-flex justify-content-center mt-5">
                                {{ $barang->links() }}
                                <!-- Panggil links() di sini untuk pagination -->
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="text-center">
                        <img src="  Template FrontEnd/img/fruite-item-1.jpg" class="img-fluid rounded" alt="">
                        <div class="py-4">
                            <a href="#" class="h5">Organic Tomato</a>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="text-center">
                        <img src="  Template FrontEnd/img/fruite-item-2.jpg" class="img-fluid rounded" alt="">
                        <div class="py-4">
                            <a href="#" class="h5">Organic Tomato</a>
                            <div class="d-flex my-3 justify-content-center">
                                <i class="fas fa-star text-primary"></i>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="text-center">
                        <img src="  Template FrontEnd/img/fruite-item-3.jpg" class="img-fluid rounded" alt="">
                        <div class="py-4">
                            <a href="#" class="h5">Organic Tomato</a>
                            <div class="d-flex my-3 justify-content-center">
                                <i class="fas fa-star text-primary"></i>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="text-center">
                        <img src="  Template FrontEnd/img/fruite-item-4.jpg" class="img-fluid rounded" alt="">
                        <div class="py-2">
                            <a href="#" class="h5">Organic Tomato</a>
                            <div class="d-flex my-3 justify-content-center">
                                <i class="fas fa-star text-primary"></i>
